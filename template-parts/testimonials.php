				...
				<ul class="glide__slides">
					<div class="testimonials-carousel__item glide__slide" data-index="1">
						<picture class="testimonials-carousel__picture">
							<img src="src/images/testimonials/avatar.png" alt="" class="testimonials-carousel__image">
						</picture>
						...
						<figcaption class="testimonials-carousel__author testimonials-carousel-author">
							...
							<img src="src/images/testimonials/signature.jpg" alt="" class="testimonials-carousel-author__signature">
						</figcaption>
					</div>
